...
Village::Village(const Fractal_t* fractal, Fractal_t::ElementInfo elem_info, const Fractal_t::Element* parent) 
    : Fractal_t::Element(fractal, elem_info, parent)
{
    if (element_info().level > 0) {
        ...
        hosp.personnel = (int) pow(2, level-1);
        hosp.free_personnel = hosp.personnel;
        hosp.num_waiting_patients = 0;
        
        hosp.assess.forward = NULL;
        hosp.assess.back = NULL;
        hosp.assess.patient = NULL;  /* ADDED FOR LLVM [OLDEN BUGS!] */
        hosp.waiting.forward = NULL;
        hosp.waiting.back = NULL;
        hosp.waiting.patient = NULL; /* ADDED FOR LLVM [OLDEN BUGS!] */
        hosp.inside.forward = NULL;
        hosp.inside.back = NULL;
        hosp.inside.patient = NULL;  /* ADDED FOR LLVM [OLDEN BUGS!] */
        hosp.up.forward = NULL;      /* ADDED FOR LLVM [OLDEN BUGS!] */
        hosp.up.back = NULL;         /* ADDED FOR LLVM [OLDEN BUGS!] */
        hosp.up.patient = NULL;      /* ADDED FOR LLVM [OLDEN BUGS!] */
        returned.back = NULL;
        returned.forward = NULL;
    }
}
