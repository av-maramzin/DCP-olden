...
using Fractal_t = abstract::Fractal<struct Village,4>;

struct Village : public typename Fractal_t::Element {

    public:

        Village(const Fractal_t*, Fractal_t::ElementInfo, const Fractal_t::Element*);
        ~Village();
