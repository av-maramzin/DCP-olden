...
struct Village* alloc_tree(int level, int label, struct Village* back, int index) {
    ...
    if (level == 0) {
        ...
        // DEBUG PRINT
        //printf("V[l=%d,d=%d,i=%d]\n", new->level, new->depth, new->index);
        //printf("GROW: \n");
        //printf("label=%d\n", new->label);
        //printf("seed=%d\n", new->seed); 
        //printf("personnel=%d\n", new->hosp.personnel); 
...
{ 
    ...
    top = alloc_tree(max_level, 0, top, 0);
...
struct List* sim(struct Village* village)
{
    ...
    // DEBUG PRINT
    //printf("V[l=%d,d=%d,i=%d]\n", village->level, village->depth, village->index);
    //printf("SIM: \n");
    //printf("hosp personnel=%d\n", village->hosp.personnel);
    //printf("hosp free personnel=%d\n", village->hosp.free_personnel); 
    //printf("num waiting patients=%d\n", village->hosp.num_waiting_patients); 
    //printf("\n");

    //printf("LIST: hosp waiting\n");
    //dumpList(&village->hosp.waiting);
    
    //printf("LIST: hosp assess\n");
    //dumpList(&village->hosp.assess); 
    
    //printf("LIST: hosp inside\n");
